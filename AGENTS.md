...
`WAProto/index.js`, `WAProto/index.d.ts` are generated by `WAProto/GenerateStatics.sh`. If a change requires modifying them, regenerate via `pnpm gen:protobuf` rather than editing by hand.
