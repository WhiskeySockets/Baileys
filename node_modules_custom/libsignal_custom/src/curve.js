...
/*CF const nodeCrypto = require('crypto'); */
const nacl = require('tweetnacl') //CF
...
exports.generateKeyPair = function() {
    try {
        /*CF const {publicKey: publicDerBytes, privateKey: privateDerBytes} = nodeCrypto.generateKeyPairSync(
            'x25519',
            {
        ...
        const pubKey = Buffer.concat([Buffer.from([5]), publicKeyRaw.slice(0, 32)])

        const privKey = privateKeyRaw.slice(0, 32)
        //CF /\
...
exports.calculateAgreement = function(pubKey, privKey) {
    ...
    /*CF if(typeof nodeCrypto.diffieHellman === 'function') {
