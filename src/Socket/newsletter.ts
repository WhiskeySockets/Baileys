import { NewsletterFetchedUpdate, NewsletterMetadata, NewsletterReaction,QueryIds, NewsletterReactionMode, NewsletterViewRole, SocketConfig, WAMediaUpload, XWAPaths } from '../Types'
